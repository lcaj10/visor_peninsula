...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-10401536.674477, 1927061.265471, -9470314.677445, 2544910.255010], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
...
map.getView().fit([-10401536.674477, 1927061.265471, -9470314.677445, 2544910.255010], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peninsula de Yucatán, Obras, 2025</h2>';
        return titleElement;
    })(),
...
attributionList.innerHTML = `
	<a href="https://https://www.gob.mx/semarnat">Semarnat</a> &middot;
